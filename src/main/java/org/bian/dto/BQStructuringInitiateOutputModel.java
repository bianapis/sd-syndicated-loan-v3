...
/**
 * BQStructuringInitiateOutputModel
 */
public class BQStructuringInitiateOutputModel   {
  private String structuringInstanceReference = null;

  private String structuringInitiateActionReference = null;
  ...
  **/
   ...
   * @return structuringInitiateActionReference
  **/

  public String getStructuringInitiateActionReference() {
    return structuringInitiateActionReference;
  }

  public void setStructuringInitiateActionReference(String structuringInitiateActionReference) {
    this.structuringInitiateActionReference = structuringInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Structuring instance (e.g. initialised, pending, active) 
